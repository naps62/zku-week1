...
# plonk does not require a specific trusted ceremony, so we skip the contribution step
# snarkjs zkey contribute Multiplier3_plonk/circuit_final.zkey Multiplier3_plonk/circuit_final.zkey --name="1st Contributor Name" -v -e="random text"
