...
describe("HelloWorld", function () {
  ...
  it("Should return true for correct proof", async function () {
    // executing the circuit, and getting in return the generated proof, and the output signals (which in this case should be the result of 1x2)
    ...
    // convert both proof and public signals into solidity calldata format, to be passed on to the verifier
    ...
    // asks the verifier contract to verify the proof
